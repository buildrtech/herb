...
export type SeverityConfig = DiagnosticSeverity | {
    editor: DiagnosticSeverity;
    cli: DiagnosticSeverity;
};
export type LinterMode = "editor" | "cli";
export declare function resolveSeverity(severity: SeverityConfig, mode: LinterMode): DiagnosticSeverity;
...
export declare class Config {
     ...
     */
    getConfiguredSeverity(ruleName: string, defaultSeverity: DiagnosticSeverity, mode?: LinterMode): DiagnosticSeverity;
    /**
